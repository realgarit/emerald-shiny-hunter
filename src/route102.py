#!/usr/bin/env python3
"""
Shiny hunt for wild Pokemon on Route 102 using flee method.
"""
...
POKEMON_SPECIES = {
    ...
    SPECIES_LOTAD: "Lotad",          # Internal: 295, National Dex: 270
    SPECIES_SEEDOT: "Seedot",        # Internal: 298, National Dex: 273
    SPECIES_RALTS: "Ralts",          # Internal: 392, National Dex: 280
}
...
POKEMON_SPECIES_EXTENDED = {
    **POKEMON_SPECIES,
    ...
    get_internal_id(270): "Lotad",      # Dex #270 -> Internal 295
    get_internal_id(273): "Seedot",     # Dex #273 -> Internal 298
    get_internal_id(280): "Ralts",      # Dex #280 -> Internal 392
...
# Encounter method: Turn in place
...
class ShinyHunter(EmulatorBase):
    """Shiny hunter for Route 102 wild encounters using flee method."""
    ...
    def __init__(self, suppress_debug=True, show_window=False, target_species=None):
        ...
        # Initialize logging
        self.log_manager = LogManager(self.log_dir, f"route102_hunt{log_suffix}")
        ...
        super().__init__(
            ...
            window_name="Shiny Hunter - Route 102"
        )
    ...
    def encounter_sequence(self, verbose=False, max_turns=1000):
        ...
        Sequence:
        - Press Left for 1 frame (turn in place), then wait 20 frames
        - Press Right for 1 frame (turn in place), then wait 20 frames
...
def main():
    parser = argparse.ArgumentParser(
        description="Pokemon Emerald Shiny Hunter - Route 102",
